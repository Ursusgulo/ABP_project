...
void generate_laplacian3D(const int N, SparseMatrixCRS <T> &laplacian_3d) {
    ...
    create_1D_laplacian_CRS(laplacian_1d.N, laplacian_1d.col, 
                            laplacian_1d.row_starts, laplacian_1d.val);

    SparseMatrixCRS <T> identity_mat(N, N);
    create_identity_matrix_CRS(identity_mat.N, identity_mat.col, 
                                identity_mat.row_starts, identity_mat.val);
